...
hueValue = Entry(window, justify=CENTER, text="0", width=4)
...
saturationValue = Entry(window, justify=CENTER, text="0", width=4)
...
valueValue = Entry(window, justify=CENTER, text="0", width=4)
...
redValue = Entry(window, justify=CENTER, text="0", width=4)
...
greenValue = Entry(window, justify=CENTER, text="0", width=4)
...
blueValue = Entry(window, justify=CENTER, text="0", width=4)
